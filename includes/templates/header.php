...
<body>
    ...
    <div class="hero">
      <div class="contenido-header">
        ...
        <div class="informacion-evento">
          ...
          <h1 class="nombre-sitio">Eventos UDG</h1>
          <p class="slogan">Informacion sobre todos los eventos desarrollados por la 
          <span>Universidad de Guadalajara</span></p>
        </div>
        <!--información evento-->
      </div>
    </div>
  ...
  <div class="barra">
    <div class="contenedor clearfix">
      <div class="logo">
          <a href="index.php">
            <img src="img/udg.png" alt="logo UDG" width="10px" height="100px">
         </a>
      </div>
